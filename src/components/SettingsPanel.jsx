    ...
    <div className="bg-white rounded-xl p-6 shadow-sm mx-6 mt-4 space-y-6 border border-gray-100">
      <div className="flex items-center justify-between">
        ...
        <div className="relative">
          <select
            className="px-4 py-1.5 w-32 bg-white border border-gray-200 rounded-lg text-sm text-gray-700 outline-none focus:ring-2 focus:ring-primary/20 appearance-none cursor-pointer hover:border-gray-300"
            value={primaryCore}
